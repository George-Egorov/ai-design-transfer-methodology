...
| --- | --- |
| License and payment | The methodology and this public repository are MIT-licensed; the plugin implementation is private. Plugin version 0.9.3 requests no payments and has no paid BRIDGE account. |
