...
| --- | --- |
| Лицензия и оплата | Методология и этот публичный репозиторий доступны по лицензии MIT; реализация плагина приватна. Версия 0.9.1 не запрашивает оплату и не использует платную учётную запись BRIDGE. |
