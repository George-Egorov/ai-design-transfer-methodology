...
| --- | --- | --- |
| BRIDGE methodology and site | **0.11.4** | Trilingual canonical docs, strict source Auto Layout policy, selected-section legacy adoption, native Figma Section canvas organization, lifecycle, structured contract/schema, tag registry, and validator artifacts. |
...
The rule catalog contains **107** rules. The public coverage snapshots record two non-additive checks:
